...
const Documents: React.FC = () => {
  const { documents, setShowUploadModal } = useApp();
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl p-4 border border-gray-200 flex flex-col md:flex-row items-stretch md:items-center gap-4">
        ...
        {filteredDocs.map(doc => (
          <div key={doc.id} className="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all flex flex-col">
            ...
            <div className="flex items-center space-x-2 mt-auto pt-4">
              <button className="flex-1 bg-blue-50 text-blue-600 py-2 rounded-lg hover:bg-blue-100 transition-colors text-sm font-medium flex items-center justify-center">
                <Eye className="w-4 h-4 mr-1" /> View
              </button>
              <button className="flex-1 bg-gray-50 text-gray-600 py-2 rounded-lg hover:bg-gray-100 transition-colors text-sm font-medium flex items-center justify-center">
